      ...
      {open && (
        ...
        >
          <div className="grid gap-2 text-sm">
            <Link onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-slate-200 hover:bg-white/5" href="/studio">
              <div className="font-semibold">Studio</div>
              <div className="text-xs text-slate-400">Visual flow builder</div>
            </Link>
            <Link onClick={() => setOpen(false)} className="rounded-lg px-3 py-2.5 text-slate-200 hover:bg-white/5" href="/cli">
              <div className="font-semibold">CLI</div>
              <div className="text-xs text-slate-400">Run flows in CI</div>
            </Link>
