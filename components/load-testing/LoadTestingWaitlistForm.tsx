...
export default function LoadTestingWaitlistForm() {
  return (
    <form className="space-y-4 text-left" action="https://submit-form.com/XOtaQHIWt" method="POST">
      <input type="hidden" name="_redirect" value="https://dev.tools/load-testing/success" />
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-white placeholder-slate-500 focus:border-neon focus:outline-none focus:ring-1 focus:ring-neon"
          defaultValue="I'm interested in API load testing with DevTools — please notify me when early access is available."
          required
        />
      </div>
