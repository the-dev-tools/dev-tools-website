...
const tocItems = [
  ...
  { id: 'migrate-vs-rebuild', label: 'Migrate vs rebuild' },
  { id: 'checklist', label: 'Pre-export checklist' },
  { id: 'step-by-step', label: 'Step-by-step migration' },
  { id: 'ci-examples', label: 'CI examples' },
      ...
      <div className="lg:grid lg:grid-cols-[1fr_260px] lg:gap-12">
        <article className="min-w-0 prose prose-invert prose-slate max-w-none">
          ...
          <section className="mb-12">
            <h2 id="who-this-is-for" className="text-3xl font-bold text-white">Who This Is For</h2>
          ...
          <section className="mb-12">
            <h2 id="migrate-vs-rebuild" className="text-3xl font-bold text-white">What to Migrate vs What to Rebuild</h2>
          ...
          <section className="mb-12">
            <h2 id="checklist" className="text-3xl font-bold text-white">Checklist Before You Export Postman</h2>
            <p className="text-slate-300">
          ...
          <section className="mb-12">
            <h2 id="step-by-step" className="text-3xl font-bold text-white">Step-by-Step Migration</h2>
          ...
          <section className="mb-12">
            <h2 id="ci-examples" className="text-3xl font-bold text-white">CI Examples</h2>
...
jobs:
  ...
  variables:
    ...
    LOGIN_PASSWORD: $LOGIN_PASSWORD`}</pre>
          ...
          <section className="mb-12">
            <h2 id="common-problems" className="text-3xl font-bold text-white">Common Problems</h2>
          ...
          <aside className="space-y-6 sticky top-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">
                Replace Postman with YAML flows
              </h3>
              <p className="text-sm text-slate-300 mb-4">
                Build flows from real browser traffic, review in PRs, run in CI.
              </p>
