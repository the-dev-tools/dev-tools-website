...
const tocItems = [
  { id: 'what-is-regression', label: 'What is regression testing' },
  { id: 'prerequisites', label: 'Prerequisites' },
  { id: 'repo-layout', label: 'Repo layout' },
  { id: 'copy-paste-github-actions-workflow', label: 'GitHub Actions workflow' },
  { id: 'matrix-testing', label: 'Matrix testing' },
  { id: 'flake-control', label: 'Flake control' },
        ...
        <article className="prose prose-invert prose-slate max-w-none min-w-0">
          <header className="mb-10 not-prose">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Deep reference: <Link href="/docs/how-to/ci-integrations" className="text-neon hover:underline">CI/CD integrations</Link> &middot;
              Template: <Link href="/templates/github-actions" className="text-neon hover:underline">GitHub Actions</Link> &middot;
              Related: <Link href="/guides/newman-alternative-ci" className="text-neon hover:underline">Newman alternative for CI</Link>
            </p>
          </header>

          <section className="mb-10">
            <h2 id="what-is-regression" className="text-3xl font-bold text-white">What &ldquo;API regression testing&rdquo; means (in practice)</h2>
          ...
          <section className="mb-10">
            <h2 id="prerequisites" className="text-3xl font-bold text-white">Prerequisites</h2>
          ...
          <section className="mb-10">
            <h2 id="repo-layout" className="text-3xl font-bold text-white">Recommended repo layout</h2>
    ...
    steps:
      ...
      - name: Publish regression report to PR
        ...
        with:
          ...
          <section className="mb-10">
            <h2 id="matrix-testing" className="text-3xl font-bold text-white">Optional: matrix testing (staging + production)</h2>
    ...
    environment:
      ...
      - name: Production
        url: ${'${{ secrets.PROD_API_BASE_URL }}'}`}</code></pre>
          ...
          <section className="mb-10">
            <h2 id="flake-control" className="text-3xl font-bold text-white">Flake control (don&rsquo;t ignore this)</h2>
            <p className="text-slate-300">
              Not everything is deterministic in API testing. Your engine can be deterministic, but traffic reality isn&rsquo;t.
          ...
          <section className="mb-10">
            ...
            <div className="not-prose space-y-3">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="text-sm text-slate-300">Install step didn&rsquo;t run due to cache logic; confirm PATH on runner.</p>
              </div>
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="text-sm text-slate-300">Confirm secrets exist and job has access. Fork PRs won&rsquo;t get secrets.</p>
              </div>
            </div>
          </section>
          ...
          <aside className="space-y-6 sticky top-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">
                Run YAML flows in GitHub Actions
              </h3>
              <p className="text-sm text-slate-300 mb-4">
                PR-visible JUnit results, caching, parallel runs, and artifact uploads.
              </p>
