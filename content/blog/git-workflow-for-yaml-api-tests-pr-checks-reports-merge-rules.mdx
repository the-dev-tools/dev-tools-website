...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/git-workflow-for-yaml-api-tests-pr-checks-reports-merge-rules/main-image.webp"
...
![Diagram showing a pull request pipeline: developer edits YAML flow, PR triggers smoke checks, JUnit results appear in PR, artifacts uploaded, merge allowed only if required checks pass.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/git-workflow-for-yaml-api-tests-pr-checks-reports-merge-rules/image-0.webp)
