...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/api-regression-testing-checklist-30-edge-cases-most-teams-miss/main-image.webp"
...
![A simple diagram of a YAML API regression flow with four boxes connected by arrows: “Auth (token)”, “Request (with variables)”, “Assertions (status, headers, JSONPath)”, and “Artifacts (JUnit, logs)”, emphasizing Git review and CI execution.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/api-regression-testing-checklist-30-edge-cases-most-teams-miss/image-0.webp)
