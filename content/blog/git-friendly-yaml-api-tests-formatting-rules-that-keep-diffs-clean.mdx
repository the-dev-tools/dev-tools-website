...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/git-friendly-yaml-api-tests-formatting-rules-that-keep-diffs-clean/main-image.webp"
...
![A GitHub pull request diff view showing a YAML API test file with a small, clean diff: one new header line added and one assertion changed, with minimal noise and consistent indentation.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/git-friendly-yaml-api-tests-formatting-rules-that-keep-diffs-clean/image-0.webp)
