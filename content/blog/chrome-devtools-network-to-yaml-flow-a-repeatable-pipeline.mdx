...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/chrome-devtools-network-to-yaml-flow-a-repeatable-pipeline/main-image.webp"
...
![A Git repository tree view showing folders flows/, env/, fixtures/, and .github/workflows/, with a highlighted YAML flow file under flows/ and a PR diff displaying a small change to one step and its assertions.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/chrome-devtools-network-to-yaml-flow-a-repeatable-pipeline/image-1.webp)
