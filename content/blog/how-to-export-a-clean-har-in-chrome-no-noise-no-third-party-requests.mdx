...
image:
  url: "https://kccqmbkylzrrhibpxtbk.supabase.co/storage/v1/object/public/public-user-assets/b460f601-795d-47ba-abf4-41fb76ccea6f/f4da5872-1cd7-4425-a30d-4d10dc4424fa/main-image.webp"
...
![Chrome DevTools Network tab showing the Preserve log and Disable cache checkboxes enabled, with the Record button active and the Clear network log button highlighted.](https://kccqmbkylzrrhibpxtbk.supabase.co/storage/v1/object/public/public-user-assets/b460f601-795d-47ba-abf4-41fb76ccea6f/f4da5872-1cd7-4425-a30d-4d10dc4424fa/image-0.webp)
...
![Network request list filtered to a single API domain, with the context menu open showing the option to save all as HAR with content.](https://kccqmbkylzrrhibpxtbk.supabase.co/storage/v1/object/public/public-user-assets/b460f601-795d-47ba-abf4-41fb76ccea6f/f4da5872-1cd7-4425-a30d-4d10dc4424fa/image-1.webp)
...
steps:
  ...
  - id: get_project
    request:
      method: GET
      url: ${BASE_URL}/api/projects/${steps.create_project.extract.project_id}
      headers:
        authorization: Bearer ${steps.login.extract.token}
    assert:
      status: 200
      jsonpath:
        $.id: ${steps.create_project.extract.project_id}
```
