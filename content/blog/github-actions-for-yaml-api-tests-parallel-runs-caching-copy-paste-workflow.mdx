...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/github-actions-for-yaml-api-tests-parallel-runs-caching-copy-paste-workflow/main-image.webp"
...
![A GitHub Actions run page showing four parallel matrix jobs (smoke, regression shard 1, shard 2, shard 3) with successful and failed statuses, plus an artifacts panel listing uploaded JUnit XML and log bundles per shard.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/github-actions-for-yaml-api-tests-parallel-runs-caching-copy-paste-workflow/image-0.webp)
