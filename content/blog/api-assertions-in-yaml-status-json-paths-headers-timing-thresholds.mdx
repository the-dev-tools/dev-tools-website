...
image:
  url: "https://dev-tools-blog-images.fly.storage.tigris.dev/blog/api-assertions-in-yaml-status-json-paths-headers-timing-thresholds/main-image.webp"
...
![Simple diagram showing a YAML flow with three steps: Step 1 sends a request and asserts status and headers, Step 2 captures a JSONPath value into a variable, Step 3 uses that variable in the next request and asserts on a JSONPath in the response.](https://dev-tools-blog-images.fly.storage.tigris.dev/blog/api-assertions-in-yaml-status-json-paths-headers-timing-thresholds/image-0.webp)
