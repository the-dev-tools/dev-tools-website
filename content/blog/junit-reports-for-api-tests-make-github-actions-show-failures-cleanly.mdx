...
cta:
  ...
  secondary:
    heading: "Keep step names stable with YAML flows"
...
- **testcase name**: step `name` that is stable in YAML
- **testcase classname** (optional): flow name, or `service.area` grouping
